...
urlpatterns = [
    ...
    path('patientclick', views.patientclick_view, name='patient-click'),

    path('adminsignup', views.admin_signup_view, name='admin-signup'),
    path('doctorsignup', views.doctor_signup_view, name='doctor-signup'),
    path('patientsignup', views.patient_signup_view, name='patient-signup'),

    path('adminlogin', views.adminLogin, name='admin-login'),
    path('doctorlogin', views.doctorLogin, name='doctor-login'),
    path('patientlogin', views.patientLogin, name='patient-login'),
